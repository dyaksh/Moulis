...
const checkIcon = (
  <svg width="16" height="13" viewBox="0 0 16 13" className="fill-current" style={{ color: primaryColor }}>
...
const AboutSectionOne = () => {
  const List = ({ text }) => (
    <p className="mb-5 flex items-center text-lg font-medium text-body-color">
      <span className="mr-4 flex h-[30px] w-[30px] items-center justify-center rounded-md" style={{ backgroundColor: `${primaryColor}1A`, color: primaryColor }}>
        {checkIcon}
      </span>
      {text}
    </p>
          ...
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              <div className="mb-12 max-w-[570px] lg:mb-0" data-wow-delay=".15s">
                <div className="mx-[-12px] flex flex-wrap">
                  ...
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    ...
                    <List text="Memorable Music & Cultural Events" />
                  </div>
                </div>
              </div>
            </div>
            <div className="w-full px-4 lg:w-1/2">
              <div className="relative mx-auto aspect-[25/24] max-w-[500px] lg:mr-0">
                <Image
                  src="/images/about/about-image1dark.svg"
                  alt="About Image"
                  fill
